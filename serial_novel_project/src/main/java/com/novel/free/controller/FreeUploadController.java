...
//			@ResponseBody
//			public ResponseEntity<List<FreeAttachVO>> uploadFormPost(MultipartFile[] uploadFile) {
//				
//				// ● 05.17 BoardAttachVO는 파일 한개, 현재 파일 업로드는 여러 파일을 동시에 업로드 해야하므로 List 사용
//				List<FreeAttachVO> list = new ArrayList<>();
//				
//				// ● 05.17 폴더 경로 받아오기
...
//					FreeAttachVO attachDTO = new FreeAttachVO();
//					
//					
//					log.info("--------이름과 사이즈 감지---------");
...
//		@ResponseBody
//		public ResponseEntity<List<FreeAttachVO>> uploadAjaxPost(MultipartFile[] uploadFile) {
//			
